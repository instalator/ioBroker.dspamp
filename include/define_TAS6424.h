...
//#define BIT(n) (1 << n) //_BV(7) || #define BIT(n) (1 << n)
...
/* TAS6424_MISC_CTRL2 */
//#define TAS6424_PWM FREQUENCY
#define TAS6424_SDM_OSR_64              (0 << 2)
#define TAS6424_SDM_OSR_128             (1 << 2)
#define TAS6424_OUTPUT_PHASE_STATE_MASK    GENMASK(1, 0)
#define TAS6424_OUTPUT_PHASE_0DEG       (0x00 << 0)
#define TAS6424_OUTPUT_PHASE_30DEG      (0x01 << 0)
#define TAS6424_OUTPUT_PHASE_45DEG      (0x10 << 0)
#define TAS6424_OUTPUT_PHASE_60DEG      (0x11 << 0)
