var lmdd = (function () {
    ...
    function animateNode(elNode) {
        ...
        if (elNode === scope) {
            cloneNode.style.top = cloneNode.rectRef.top + window.pageYOffset - 64 + "px";
    ...
    function updateMirrorLocation() {
        mirror.style.top = (lastEvent.pageY - parseInt(mirror.parentNode.style.top, 10) + scrollDelta.y - dragOffset.y) - 64 + "px";
