...
systemDictionary = {
    ...
    'Reset device':                                               {
        ...
        'ru':    'Сбросить устройство',
        'pt':    'Reinicie o dispositivo',
        'nl':    'Reset het apparaat',
        'fr':    'Réinitialiser l\'appareil',
        'it':    'Ripristina dispositivo',
        'es':    'Reiniciar el dispositivo',
        'pl':    'Zresetować urządzenie',
        'zh-cn': '重置设备'
    },
    'ATTENTION!':                                                 {
        'en':    'ATTENTION!',
    ...
    'Are you sure you want to reset all settings DSP amplifier?': {
        'en':    'Are you sure you want to reset all settings DSP amplifier?',
        'de':    'Möchten Sie wirklich alle Einstellungen des DSP-Verstärkers zurücksetzen?',
        'ru':    'Вы уверены, что хотите сбросить все настройки DSP усилителя?',
        'pt':    'Tem certeza de que deseja redefinir todas as configurações do amplificador DSP?',
        'nl':    'Weet u zeker dat u alle instellingen van de DSP-versterker wilt resetten?',
        'fr':    'Êtes-vous sûr de vouloir réinitialiser tous les paramètres de l\'amplificateur DSP ?',
        'it':    'Sei sicuro di voler ripristinare tutte le impostazioni dell\'amplificatore DSP?',
        'es':    '¿Está seguro de que desea restablecer todos los ajustes del amplificador DSP?',
        'pl':    'Czy na pewno chcesz zresetować wszystkie ustawienia wzmacniacza DSP?',
        'zh-cn': '您确定要重置 DSP 放大器的所有设置吗？'
    },
    'Cancel':                                                     {
        'en':    'Cancel',
        'de':    'Abbrechen',
